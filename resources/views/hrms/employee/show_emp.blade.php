    ...
    <header id="topbar" class="alt">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-current-item"> Quản lý nhân viên</li>
            </ol>
        </div>
    </header>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title hidden-xs">Danh sách nhân viên</span><br />
                        </div><br />
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group text-right">
                                                <button type="button"
                                                        ...
                                                        data-toggle="dropdown" aria-expanded="false"> Tùy chọn
                                                    <span class="caret ml5"></span>
                                                </button>
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>
                                                        <a href="/edit-emp/{{$emp->id}}">Sửa</a>
                                                    </li>
                                                    <li>
                                                        <a href="/delete-emp/{{$emp->id}}">Xóa</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
