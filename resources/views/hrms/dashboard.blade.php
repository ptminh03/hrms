...
<header id="topbar" class="alt">
    <div class="topbar-left">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-current-item">Bảng điều khiển</li>
        </ol>
    </div>
                    ...
                    <div class="panel-body">
                        <div class="row pv10">
                            ...
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"><a href="{{'employee-manager'}}"> NHÂN VIÊN</a></h3>
                                <h5 class="mt5 mbn">385</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-tile">
                    <div class="panel-body">
                        <div class="row pv10">
                            ...
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"> <a href="{{'total-leave-list'}}"> NGHỈ PHÉP <br/> </a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-tile">
                        <div class="panel-body">
                            <div class="row pv10">
                                ...
                                <div class="col-xs-7 pl5">
                                    <h3 class="text-muted"> <a href="{{'asset-listing'}}"> ASSET <br /> MANAGER </a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row pv10">
                                <div class="col-xs-5 ph10"><img src="/assets/img/pages/dollar.jpg"
                                                                class="img-responsive mauto" style="height: 100px; width: 100px;" alt=""/></div>
                                <div class="col-xs-7 pl5">
                                    <h3 class="text-muted"> <a href="{{'expense-list'}}"> EXPENSE <br /> MANAGER </a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="/assets/img/pages/clipart5.png"
                                                            class="img-responsive mauto" alt=""/></div>
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"><a href="{{'attendance-manager'}}"> ATTENDANCE MANAGER </a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="row pv10">
                                <div class="col-xs-5 ph10"><img src="/assets/img/pages/clipart0.png"
                                                                class="img-responsive mauto" alt=""/></div>
                                <div class="col-xs-7 pl5">
                                    <h3 class="text-muted"><a href="{{'my-leave-list'}}"> LEAVES </a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="row pv10">
                            <div class="col-xs-5 ph10"><img src="/assets/img/pages/clipart6.png"
                                                            class="img-responsive mauto" alt=""/></div>
                            <div class="col-xs-7 pl5">
                                <h3 class="text-muted"><a href='hr-policy'> CHÍNH SÁCH </a></h3>
                            </div>
                        </div>
                    </div>
                </div>
