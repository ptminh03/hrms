            ...
            if (d1 !== '' && d2 !== '') {
                ...
                for (var d = new Date($("#datepicker1").val()); d <= new Date($("#datepicker4").val()); d.setDate(d.getDate() + 1)) {
                    if (d.getDay() !== 0 && d.getDay() !== 6) {
                        ...
                        str += "<td class='text-center'><input type='radio' name='" + formatDate(d) + "' value='0'></td>"
                        str += "<td class='text-center'><input type='radio' name='" + formatDate(d) + "' value='1'></td>"
                        str += "<td class='text-center'><input type='radio' name='" + formatDate(d) + "' value='2' checked></td>"
                        str += "</tr>"
                    }
                }
            str += "</table>"
