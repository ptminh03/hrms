            ...
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-link">
                        <a href="{{route('news.add')}}">Thêm tin tức</a>
                    </li>
                </ol>
            </div>
        </header>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                                <span class="panel-title hidden-xs"> Thêm tin tức </span>
                        </div>
                        <div class="panel-body pn">
                            ...
                            <div>
                            Last name:
                            <textarea name="content" id="texteditor" placeholder="Content"></textarea>
                            </div>
...
<!-- -------------- jQuery -------------- -->
<script>    CKEDITOR.replace( 'texteditor' );</script>
